...
{
    // Try & allocate memory for the hashmap, in the event of a memory allocation failure, return
    // a null pointer and display a fatal error message.
    ...
    // Try & allocate memory for the nodes, in the event of a memory allocation failure, return
    // a null pointer and display a fatal error message.
